...
namespace SbrinnaCoreFramework.Activity
{
    ...
    public class ActivityTrace
    {
        ...
        public static string RenderTraceTableForItem(long itemId, long companyId, TargetType targetType)
        {
            var res = new StringBuilder();
            var activities = ActivityLog.GetActivity(itemId, targetType, companyId, null, null);
