...
// </copyright>
// -----------------------------------------------------------------------
namespace SbrinnaCoreFramework.Activity
{
    using System;
    ...
    public class ActionResult
    {
        ...
        public void SetSuccess(int newItemId)
        {
            this.Success = true;
            this.MessageError = string.Empty;
            this.ReturnValue = newItemId.ToString(CultureInfo.GetCultureInfo("en-us"));
        }

        /// <summary>Sets the success of action to true with a message</summary>
        /// <param name="newItemId">Identifier of new item added in database</param>
        public void SetSuccess(Guid newItemId)
        {
            this.Success = true;
            this.MessageError = string.Empty;
            this.ReturnValue = newItemId.ToString().ToUpperInvariant();
        }
        ...
        {
            this.Success = true;
            this.ReturnValue = newItemId.ToString(CultureInfo.InvariantCulture);
            this.MessageError = string.Empty;
        }
