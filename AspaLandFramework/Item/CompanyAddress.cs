...
namespace AspadLandFramework.Item
{
    ...
    public class CompanyAddress
    {
        ...
        /// <param name="other">Second address</param>
        /// <returns>Descriptive text with the differences between tow company address</returns>
        public string Differences(CompanyAddress other)
        {
            ...
            {
                res.Append("Address:").Append(other.Address).Append(", ");
            }

            if (this.PostalCode != other.PostalCode)
            {
                res.Append("PostalCode:").Append(other.PostalCode).Append(", ");
            }

            if (this.City != other.City)
            {
                res.Append("City:").Append(other.City).Append(", ");
            }

            if (this.Province != other.Province)
            {
                res.Append("Province:").Append(other.Province).Append(", ");
            }

            if (this.Country != other.Country)
            {
                res.Append("Country:").Append(other.Country).Append(", ");
            }

            if (this.Phone != other.Phone)
            {
                res.Append("Phone:").Append(other.Phone).Append(", ");
            }

            if (this.Mobile != other.Mobile)
            {
                res.Append("Mobile:").Append(other.Mobile).Append(";");
            }

            if (this.Fax != other.Fax)
            {
                res.Append("Fax:").Append(other.Fax).Append(", ");
            }

            if (this.Email != other.Email)
            {
                res.Append("Email:").Append(other.Email).Append(", ");
            }
        ...
        public ActionResult Insert(int userId)
        {
            ...
            using (var cmd = new SqlCommand("CompanyAddress_Insert"))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add(DataParameter.Input("@Country", this.Country, 15));
