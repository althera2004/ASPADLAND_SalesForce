                            ...
                            <div id="login-box" class="login-box visible widget-box no-border" style="z-index: 99999; background-color: transparent; box-shadow: 4px 4px 4px rgba(0, 0, 0, 0.25)">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <h4 class="header black lighter bigger" id="PageTitle">Recuperar contrase&ntilde;a</h4>
                                        ...
                                        <form id="LoginForm" action="InitSession.aspx" method="post">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="space"></div>
                                                <div class="clearfix">
													<button type="button" class="width-35 pull-right btn btn-sm btn-primary" id="BtnReset">Recuperar</button>
                                                </div>
                                        ...
                                        I.P. de acceso:<strong><%=this.IP %></strong>-->
                                    </div>
                                </div>
                            </div>
                        </div>
