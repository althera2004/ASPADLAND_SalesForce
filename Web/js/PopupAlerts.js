function alertUI(message) {
    ...
    var dialog = $("#AlertUIDialog").removeClass("hide").dialog({
        ...
        [
            {
                "html": "<i class=\"fas fa-check bigger-110\"></i>&nbsp;" + Dictionary.Common_Accept,
...
function promptInfoUI(message, width, actionYes, actionNo) {
    ...
    var dialog = $("#PromptUIDialog").removeClass("hide").dialog({
        ...
        "buttons": [
            {
                "html": "<i class=\"fas fa-check bigger-110\"></i>&nbsp;" + Dictionary.Common_Yes,
                "class": "btn btn-xs btn-success",
                "click": function () {
                    $(this).dialog("close");
                    if (actionYes != null) {
            ...
            {
                "html": "<i class=\"fas fa-times bigger-110\"></i>&nbsp;" + Dictionary.Common_No,
